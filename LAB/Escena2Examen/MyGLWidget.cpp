...
void MyGLWidget::projectTransform ()
{
  ...
  if (perspectiva)
    Proj = glm::perspective(FOV, raw, 0.1f, 3.0f*radiEsc);
  else
...
/*
  ...
  View = glm::translate(View, -VRP);*/
    ...
    View = glm::rotate(View, -angleY,  glm::vec3(0,1,0)); // gira
    View = glm::rotate(View, angleX, glm::vec3(1,0,0));
    View = glm::rotate(View, 0.0f,   glm::vec3(0,0,1));

/*EN ESTE ARCHIVO SOLO CREAMOS UNA CASITA
  COMO MODIFICAR VERTICES Y QUE TOCAR*/
...
//  glViewport (0, 0, ample, alt);
  ...
  // Pintem l'escena
  glDrawArrays(GL_TRIANGLES, 0, 9); //Aqui espeecificamos el numero de vertices a pintar
...
void MyGLWidget::creaBuffers ()
{
  ...
  */
  ...
  /*Estos 3 vertices de debajo hacen el techo de la casita*/

  Vertices[6] = glm::vec3(-0.5, 0.5, 0.0);
  Vertices[7] = glm::vec3(0, 1, 0.0);

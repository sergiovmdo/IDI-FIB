/*En este ejercicio tenemos un foco de ESCENA calculado en el VERTEX SHHADER*/
...
void MyGLWidget::initializeGL ()
{
  ...
  //Esto es para moverlo con las teclectias (codigo abajo)
  posFocusX = 1;
  //Cosas para pasar el uniform al VS
...
void MyGLWidget::createBuffersTerraIParet ()
{
  ...
  //Si no brilla probamos a poner el priemr parametro a 0 pero no deberiamos de hacerlo
  glm::vec3 diff(0,0,0.8);

  //Para que brille el material hay que poner este vector a 1
  glm::vec3 spec(1,1,1);

  /*Que yo sepa esto contra mas pequeño mas gordo es el foco asi que asi esta guachi*/
  float shin = 100;
...
void MyGLWidget::carregaShaders()
{
  ...
  //Los pasamos como uniforms en vez de crearlos en el VS

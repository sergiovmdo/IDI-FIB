/*En este el foco es de CAMARA y se calcula en el FS*/
...
void MyGLWidget::createBuffersTerraIParet ()
{
  ...
  //el primer parametro a 9 si queremos que brille y tampoco ni idea julio
  glm::vec3 diff(0,0,0.8);

  //Vale si queremos que brille hay q poner este vector a 1 npi de pq
  glm::vec3 spec(1,1,1);
  float shin = 100;

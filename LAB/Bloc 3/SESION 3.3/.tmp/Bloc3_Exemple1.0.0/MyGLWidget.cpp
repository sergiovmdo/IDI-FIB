/*Si quiero apagar un foco le quito toda su intensidad de luz,
  vamos que hay que poner colFocus een (0,0,0) y para encenderlo
  pues le volvemos a poner normal, no está puesto por aqui pq me dio palo
  pero se hace asi*/
...
void MyGLWidget::keyPressEvent(QKeyEvent* event) 
{
  ...
  /*Esto sirve para activar y desactivar el backfaceculling*/
  case Qt::Key_B: {
